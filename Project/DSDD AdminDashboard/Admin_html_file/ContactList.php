...
<!--            Register Content Starts-->
            <div class="col-sm-9 col-md-10 main">
                <h1 class="page-header"><i class="far fa-address-card"></i> Contact List </h1>
        ...
        <table class="table table-striped" id ="editTable">
            ...
            <tbody id="tableBody">
                <?php
                    include 'Conn.php';
                    $space=' ';
                    $sql = "SELECT CONCAT(First_Name, space(1),Last_Name) AS NAME, Email_Id,  Mobile_Number, State, Pin_Code FROM add_officer";
                    ...
                    { 
                        ...
                        {
                            echo "<tr><td>".$row["NAME"]."</td><td>".$row["Email_Id"]."</td><td>".$row["Mobile_Number"]."</td><td>".$row["State"]."</td><td>".$row["Pin_Code"]."</td></tr>";
                        }
                        echo "</table>";
                    } 
                    else 
...
<!--<script src="../js/Admin/index4.js"></script>-->
</body>

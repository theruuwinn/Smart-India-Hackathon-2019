...
<!--            Register Content Starts-->
            <div class="col-sm-9 col-md-10 main">
                <h1 class="page-header"><i class="fas fa-file-invoice"></i> Reports List </h1>
        ...
        <table class="table table-striped" id ="editTable">
            ...
            <tbody id="tableBody">
                ...
                <?php
                    include 'Conn.php';
                    $space=' ';
                    $sql = "SElECT File_Name, URL, File_Link, Timestamp from collected_data ORDER BY Timestamp DESC";
...
<!--<script src="../js/Admin/adminDataList.js"></script>-->
</body>
